...
This problem will be studied further in Subsection \ref{sub:Horn}.\\





To end this section we will introduce one of the most complicated generalization. Stochastic SAT or SSAT. This variation was first introduced in \cite{papadimitriou1985games}. The information provided for this problem comes from \cite{majercik2009stochastic}.\\





A SSAT problem is defined by TODO - Incluir en la parte práctica y desarrollar algoritmo.
\begin{itemize}
\item   A \emph{prefix} $Q_1 v_1 ... Q_nv_n$ that orders a set of $N$ variables 
\end{itemie}
