...
The code uploaded may be subject to small modifications or corrections, so we recommend to check the link best. Nonetheless, the code was attached.
...
\begin{tikzpicture}[%
  ...
  \node [selected]{\texttt{SATreduce}}
    child { node  {\texttt{graph}}
      ...
      child { node [optional] {\texttt{minimun\_coloring}}}
      child { node [optional] {\texttt{minimun\_dominating\_subset}}}
    }
    child [missing] {}				
    child [missing] {}				
    child [missing] {}				
