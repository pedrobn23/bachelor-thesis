...
\begin{equation}
    \begin{split}
      ...
      & =^{poly} {\displaystyle 2^{2h(1/k) n}  2^{-n}   \left (\frac{1}{k}\right )^{\lfloor n/k\rfloor}  \left (\frac{k-1}{k}\right )^{n-\lfloor n/k\rfloor}  }\\
\end{split}
\end{equation}
TODO: NO SE COMO SALE EL ÚLTIMO PASO , COMO SE RESUELVE ESTO¿??
