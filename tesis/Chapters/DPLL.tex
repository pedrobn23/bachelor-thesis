...
\begin{definition}
 ...
 \end{definition} 
 As we can see a decisión graph is dependent of the order on which the variables are assigned (should a decision be maked) and the value choosen for each variable when this decision happens.\\
