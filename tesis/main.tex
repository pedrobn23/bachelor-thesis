...
\thesistitle{Consistency in Propositional Logic} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\emph{Author:}\\
\href{https://github.com/pedrobn23/TFG/}{\authorname} % Author name - remove the \href bracket to remove the link
\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.4\textwidth}
...
\large \textit{A thesis submitted in fulfillment of the requirements\\ for the degrees of \degreename}\\[0.3cm] % University requirement text
\textit{in the}\\[0.4cm]
%\groupname\\
